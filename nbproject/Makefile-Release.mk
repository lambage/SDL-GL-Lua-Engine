...
${OBJECTDIR}/SceneManager/GLObject.o: SceneManager/GLObject.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SceneManager/GLObject.o SceneManager/GLObject.cpp

${OBJECTDIR}/SceneManager/SceneManager.o: SceneManager/SceneManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/SceneManager
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SceneManager/SceneManager.o SceneManager/SceneManager.cpp

${OBJECTDIR}/Util/Log.o: Util/Log.cpp 
	${MKDIR} -p ${OBJECTDIR}/Util
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Util/Log.o Util/Log.cpp
